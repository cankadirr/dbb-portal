// src/components/composer/blocks/MeclisKarariBlock.tsx
import React from "react";

interface MeclisKarariBlockProps {
  id: string;
  title?: string;
  items: { title: string; date: string; documentUrl?: string }[];
}

export const MeclisKarariBlock: React.FC<MeclisKarariBlockProps> = ({ title, items }) => (
  <section>
